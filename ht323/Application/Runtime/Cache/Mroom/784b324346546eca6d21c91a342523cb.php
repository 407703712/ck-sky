        ...
        <ul class="layui-nav right" lay-filter="">
          <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
              ...
              <dd><a id="outLoginBtn" href="<?php echo U('/mroom/login/out_login');?>">退出</a></dd>
            </dl>
          </li>
    ...
    <div id="side-nav">
        <ul id="nav">
            <li class="open">
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<?php echo U('/mroom/workspace/index');?>">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>会议室管理</cite>
                        </a>
                    </li>
        ...
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
          ...
          <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src="<?php echo U('/mroom/home/welcome');?>" frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
          </div>
        </div>
    </div>
